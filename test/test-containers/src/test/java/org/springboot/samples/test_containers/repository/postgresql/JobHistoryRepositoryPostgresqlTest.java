package org.springboot.samples.test_containers.repository.postgresql;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import org.springboot.samples.test_containers.model.JobHistory;
import org.springboot.samples.test_containers.repository.JobHistoryRepository;
...
public class JobHistoryRepositoryPostgresqlTest extends BaseTest {
    ...
    public void create() {
        ...
        assertThat(saveJobHistory).usingRecursiveComparison().ignoringFields("jobHistoryId").isEqualTo(jobHistory);
    }
    ...
    @Override
    public void read() {
        Optional<JobHistory> jobHistoryOptional=jobHistoryRepository.findById(jobHistory.getJobHistoryId());
    ...
    public void delete() {
     ...
     Optional<JobHistory> optionalJobHistory=jobHistoryRepository.findById(jobHistory.getJobHistoryId());
