package springboot.samples.kafka01_consumer.config;
...
public class KafkaConsumerConfig {
     ...
     */
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String,String>> listenerContainerFactory(ConsumerFactory consumerFactory){
