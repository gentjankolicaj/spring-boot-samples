...
public class KafkaConsumerConfig {
     ...
     */
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Location>> listenerContainerFactory(@Qualifier("consumerFactory") ConsumerFactory<String, Location> consumerFactory){
