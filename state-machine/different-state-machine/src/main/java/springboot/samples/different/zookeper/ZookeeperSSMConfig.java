...
public class ZookeeperSSMConfig {
    ...
    @Bean("zookeeperSSM")
    public StateMachine<ZookeeperSSMState, ZookeeperSSMEvent> createStateMachine(CuratorFramework curatorFramework) throws Exception {
        ...
        builder.configureTransitions()
                .withExternal()
                .source(ZookeeperSSMState.LOCKED).target(ZookeeperSSMState.UNLOCKED).event(ZookeeperSSMEvent.COIN)
                .and()
                .withExternal()
                .source(ZookeeperSSMState.UNLOCKED).target(ZookeeperSSMState.LOCKED).event(ZookeeperSSMEvent.PUSH);
    ...
    @Bean
    public StateMachineEnsemble<ZookeeperSSMState, ZookeeperSSMEvent> createStateMachineEnsemble(CuratorFramework curatorFramework) {
